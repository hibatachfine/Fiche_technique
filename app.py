...
code_cabine = bloc["C_Cabine"]
code_chassis = bloc["C_Chassis"]
code_caisse = bloc["C_Caisse"]
code_moteur = bloc["M_moteur"]
code_frigo = bloc["C_Groupe frigo"]
code_hayon = bloc["C_Hayon elevateur"]
